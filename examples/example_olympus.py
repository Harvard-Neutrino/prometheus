...
for rset in range(1000):
    try:
        ...
        config['lepton injector']['simulation']["injection radius"] = 500
        config['lepton injector']['simulation']["endcap length"] = 500
        config['lepton injector']['simulation']["cylinder radius"] = 500
        config['lepton injector']['simulation']["cylinder height"] = 1200
