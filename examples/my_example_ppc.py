...
def main(args=None):
    ...
    config['lepton injector']['simulation']['output name'] = "/n/holyscratch01/arguelles_delgado_lab/Everyone/jlazar/muons/data/data_%d_output_LI.h5" % rset
    config['photon propagator']['storage location'] = '/n/holyscratch01/arguelles_delgado_lab/Everyone/jlazar/muons/data/rset_%d_' % rset
    nevent = 10
    ...
    config['photon propagator'][photo_prop]['ppc_tmpfile'] = f".{rset}_event_hits.ppc.tmp"
    config['photon propagator'][photo_prop]['f2k_tmpfile'] = f".{rset}_event_losses.f2k.tmp"
    #config['photon propagator']['ppc_prefix'] = f"{rset}_"
    #config['photon propagator']['f2k_prefix'] = f"{rset}_"
