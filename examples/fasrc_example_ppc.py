...
def main(args=None):
    ...
    config['photon propagator'][photo_prop]['ppc_tmpfile'] = f"/n/home12/jlazar/hebe_new/examples/.{rset}_event_hits.ppc.tmp"
    config['photon propagator'][photo_prop]['f2k_tmpfile'] = f"/n/home12/jlazar/hebe_new/examples/.{rset}_event_losses.f2k.tmp"
