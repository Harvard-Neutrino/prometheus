...
INJECTOR_DICT = {RegisteredInjectors.LEPTONINJECTOR: make_new_LI_injection}

INJECTION_CONSTRUCTOR_DICT = {RegisteredInjectors.LEPTONINJECTOR: injection_from_LI_output}
