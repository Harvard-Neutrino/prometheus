...
class ParquetWeighter(Weighter):
    ...
    def _get_event_oneweight(self, event: ak.Record) -> float:
        ...
        lw_event.final_state_particle_0 = LW.ParticleType(
            injection["final_state_type"][final_state_1_idx]
        )
        lw_event.final_state_particle_1 = LW.ParticleType(
            injection["final_state_type"][final_state_2_idx]
        )
